...
//     // Update buttons
//     toggleSignup.classList.toggle('active', form === 'signup');
//     toggleLogin.classList.toggle('active', form === 'login');
...
//         // Success alert
//         const Swal = (await import('https://cdn.jsdelivr.net/npm/sweetalert2@11')).default;
//         await Swal.fire({
//             icon: 'success',
